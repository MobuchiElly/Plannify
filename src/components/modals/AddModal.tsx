...
const [error, setError] = useState('');
  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center'>
        <div className='min-h-[70vh] w-full mx-5 bg-white lg:w-[60vw] min-w-[50vw] mb-6 mt-20 p-4 px-6 relative flex flex-col justify-center items-center rounded-xl'>
            ...
            <div className='pt-2 w-[75vw] md:w-[70vw] lg:w-[50vw]'>
                ...
                }} className='outline outline-1 w-full p-2 mb-6 rounded'/>
                <label>Set a Reminder</label>
                <input type="datetime-local"
                value={reminderTime}
                onChange={(e) => setReminderTime(e.target.value)} className="outline outline-1 w-full p-2 mb-10 rounded"/>
