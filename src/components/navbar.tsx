  ...
  return (
    <nav className='h-36 w-screen bg-gray-700 bottom-0 text-white flex items-center'>
      <div className='relative w-full h-full py-3'>
        ...
        <h2 className='text-center text-2xl font-mono p-2 font-[500]'>Never Fail to Plan... Never Plan to Fail</h2>
        <button className='absolute right-10 top-10' onClick={() => setLightTheme(!lightTheme)}>
          {
